...
void SteepParallaxMappingScene::renderQuad()
{
    if (quadVAO == 0)
    {
        // positions
...
void SteepParallaxMappingScene::setHeightScale(float heightScale) {
    SteepParallaxMappingScene::heightScale = heightScale;
}
