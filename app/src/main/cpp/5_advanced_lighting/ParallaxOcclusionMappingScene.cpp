...
void ParallaxOcclusionMappingScene::renderQuad()
{
    if (quadVAO == 0)
    {
        // positions
...
void ParallaxOcclusionMappingScene::setHeightScale(float heightScale) {
    ParallaxOcclusionMappingScene::heightScale = heightScale;
}
