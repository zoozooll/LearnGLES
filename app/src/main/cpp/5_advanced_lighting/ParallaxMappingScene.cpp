...
void ParallaxMappingScene::init() {
    ...
    // -------------------------
    shader = new Shader("5/5.1.parallax_mapping.vsh", "5/5.1.parallax_mapping.fsh");
    ...
    diffuseMap = loadTexture("textures/toy_box_diffuse.png");
...
void ParallaxMappingScene::setHeightScale(float heightScale) {
    ParallaxMappingScene::heightScale = heightScale;
}
