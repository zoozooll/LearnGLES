...
// -------------------------
    shaderGeometryPass = new Shader("5/8.1.g_buffer.vsh", "5/8.1.g_buffer.fsh");
    shaderLightingPass = new Shader("5/8.1.deferred_shading.vsh", "5/8.1.deferred_shading.fsh");
    shaderLightBox = new Shader("5/8.1.deferred_light_box.vsh", "5/8.1.deferred_light_box.fsh");
...
void DeferredShadingScene::resize(int width, int height) {
...
void DeferredShadingScene::destroy() {
    delete camera;
