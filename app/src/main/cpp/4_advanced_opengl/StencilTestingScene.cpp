...
void StencilTestingScene::init() {
    ...
    // -------------------------
    shader = new Shader("4/2.stencil_testing.vsh", "4/2.stencil_testing.fsh");
    shaderSingleColor = new Shader("4/2.stencil_testing.vsh", "4/2.stencil_single_color.fsh");
...
void StencilTestingScene::setStencilTest() const {
    ...
    glStencilOp(stencilOpSfail, stencilOpDfail, stencilDppass);
}
...
void StencilTestingScene::setStencilTesting(bool stencilTesting) {
    StencilTestingScene::stencilTesting = stencilTesting;
}

void StencilTestingScene::setStencilFunc(int stencilFunc) {
    StencilTestingScene::stencilFunc = stencilFunc;
}

void StencilTestingScene::setStencilOpSfail(int stencilOpSfail) {
    StencilTestingScene::stencilOpSfail = stencilOpSfail;
}

void StencilTestingScene::setStencilOpDfail(int stencilOpDfail) {
    StencilTestingScene::stencilOpDfail = stencilOpDfail;
}
