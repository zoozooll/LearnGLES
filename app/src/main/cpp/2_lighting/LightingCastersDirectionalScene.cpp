...
// -------------------------
    lightingShader = new Shader("2/5.1.light_casters.vert", "2/5.1.light_casters.frag");
    lightCubeShader = new Shader("2/5.1.light_cube.vert", "2/5.1.light_cube.frag");
...
void LightingCastersDirectionalScene::move(const glm::vec2 &start_pivot, const glm::vec2 &end_pivot) {
...
void LightingCastersDirectionalScene::scale(const float &scale) {
    float zoom = 0.f;
    if (scale > 1.02f) {
        zoom = 1.f;
    } else if (scale < 0.98f) {
...
void LightingCastersDirectionalScene::yawPitch(const glm::vec2 &director) {
    camera->ProcessMouseMovement(director.x, director.y);
}

void LightingCastersDirectionalScene::onDoubleClick(const glm::vec2 &point) {
