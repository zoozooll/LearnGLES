...
#include "CoordinateSystemExercise4Scene.h"
...
void CoordinateSystemExercise4Scene::init() {
...
void CoordinateSystemExercise4Scene::resize(int width, int height) {
    glViewport(0, 0, width, height);
    SCR_WIDTH = width;
    SCR_HEIGHT = height;
}

void CoordinateSystemExercise4Scene::draw() {
    // render
    // ------
...
void CoordinateSystemExercise4Scene::destroy() {
...
CoordinateSystemExercise4Scene::sendCommand(std::map<std::string, std::any> commands) {
...
void CoordinateSystemExercise4Scene::translate(glm::vec3 t) {

}

void CoordinateSystemExercise4Scene::rotate(glm::vec3 r) {

}

void CoordinateSystemExercise4Scene::scale(glm::vec3 s) {
...
void CoordinateSystemExercise4Scene::rotateY(float d) {
    vec3 l_scale;
    quat l_rotation;
    vec3 translation;
    vec3 skew;
...
void CoordinateSystemExercise4Scene::rotateZ(float d) {
    vec3 l_scale;
    quat l_rotation;
    vec3 translation;
    vec3 skew;
...
void CoordinateSystemExercise4Scene::scaleX(float s) {
    vec3 l_scale;
    quat l_rotation;
    vec3 translation;
    vec3 skew;
...
void CoordinateSystemExercise4Scene::scaleY(float s) {
    vec3 l_scale;
    quat l_rotation;
    vec3 translation;
    vec3 skew;
...
void CoordinateSystemExercise4Scene::scaleZ(float s) {
    vec3 l_scale;
    quat l_rotation;
    vec3 translation;
    vec3 skew;
