...
#include "TextureExercise4Scene.h"
...
void TextureExercise4Scene::init() {
    // build and compile our shader zprogram
    // ------------------------------------
    ourShader = new Shader("1/4.6.texture.vert", "1/4.6.texture.frag");
...
void TextureExercise4Scene::resize(int width, int height) {
    glViewport(0, 0, width, height);
}

void TextureExercise4Scene::draw() {
// render
    // ------
...
void TextureExercise4Scene::destroy() {
