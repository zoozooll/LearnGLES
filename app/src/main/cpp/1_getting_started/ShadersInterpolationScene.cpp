...
#include "ShadersInterpolationScene.h"
...
// build and compile our shader program
    ...
    if (!success)
    {
        ...
        LOGE("ShadersInterpolationScene", "ERROR::SHADER::VERTEX::COMPILATION_FAILED: %s",infoLog);
    }
    // fragment shader
    ...
    if (!success)
    {
        ...
        LOGE("ShadersInterpolationScene", "ERROR::SHADER::FRAGMENT::COMPILATION_FAILED: %s",infoLog);
    }
    // link shaders
    ...
    if (!success) {
        ...
        LOGE("ShadersInterpolationScene", "ERROR::SHADER::PROGRAM::LINKING_FAILED %s",infoLog);
    }
...
void ShadersInterpolationScene::resize(int width, int height) {
    glViewport(0, 0, width, height);
}

void ShadersInterpolationScene::draw() {
// render
    // ------
...
void ShadersInterpolationScene::destroy() {
