...
#include "ShadersExercise3Scene.h"
...
void ShadersExercise3Scene::resize(int width, int height) {
    glViewport(0, 0, width, height);
}

void ShadersExercise3Scene::draw() {
    // render
    // ------
...
void ShadersExercise3Scene::destroy() {
