...
#include "TextureExercise1Scene.h"
...
void TextureExercise1Scene::init() {
// build and compile our shader zprogram
    // ------------------------------------
    ourShader = new Shader("1/4.3.texture.vert", "1/4.3.texture.frag");
...
void TextureExercise1Scene::resize(int width, int height) {
    glViewport(0, 0, width, height);
}

void TextureExercise1Scene::draw() {
    // render
    // ------
...
void TextureExercise1Scene::destroy() {
