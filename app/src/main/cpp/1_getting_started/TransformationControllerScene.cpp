...
#include "TransformationControllerScene.h"
...
void TransformationControllerScene::init() {
...
void TransformationControllerScene::resize(int width, int height) {
    glViewport(0, 0, width, height);
    SCR_WIDTH = width;
    SCR_HEIGHT = height;
}

void TransformationControllerScene::draw() {
    // render
    // ------
...
void TransformationControllerScene::destroy() {
...
TransformationControllerScene::sendCommand(std::map<std::string, std::any> commands) {
...
void TransformationControllerScene::translate(glm::vec3 t) {

}

void TransformationControllerScene::rotate(glm::vec3 r) {

}

void TransformationControllerScene::scale(glm::vec3 s) {

}

void TransformationControllerScene::translateX(float t) {
...
void TransformationControllerScene::translateY(float t) {
    vec3 l_x = glm::normalize(glm::mat3(model) * Y_AXIS);
    mat4 l_matrix = glm::translate(mat4(1.f), l_x * t * 0.01f);
    model = l_matrix * startMatrix;
}

void TransformationControllerScene::translateZ(float t) {
    vec3 l_x = glm::normalize(glm::mat3(model) * Z_AXIS);
    mat4 l_matrix = glm::translate(mat4(1.f), l_x * t * 0.01f);
    model = l_matrix * startMatrix;
}

void TransformationControllerScene::rotateX(float d) {
    vec3 l_scale;
    quat l_rotation;
    vec3 translation;
    vec3 skew;
...
void TransformationControllerScene::rotateY(float d) {
    vec3 l_scale;
    quat l_rotation;
    vec3 translation;
    vec3 skew;
...
void TransformationControllerScene::rotateZ(float d) {
    vec3 l_scale;
    quat l_rotation;
    vec3 translation;
    vec3 skew;
...
void TransformationControllerScene::scaleX(float s) {
    vec3 l_scale;
    quat l_rotation;
    vec3 translation;
    vec3 skew;
...
void TransformationControllerScene::scaleY(float s) {
    vec3 l_scale;
    quat l_rotation;
    vec3 translation;
    vec3 skew;
...
void TransformationControllerScene::scaleZ(float s) {
    vec3 l_scale;
    quat l_rotation;
    vec3 translation;
    vec3 skew;
...
void TransformationControllerScene::update() {
    mat4 l_matrix(1.f);
    model = l_matrix;
}

void TransformationControllerScene::startTransform() {
    startMatrix = model;
}

void TransformationControllerScene::endTransform() {
