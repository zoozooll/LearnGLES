...
#include "CoordinateSystemScene.h"
...
void CoordinateSystemScene::resize(int width, int height) {
    glViewport(0, 0, width, height);
    SCR_WIDTH = width;
    SCR_HEIGHT = height;
}

void CoordinateSystemScene::draw() {
// render
    // ------
...
void CoordinateSystemScene::destroy() {
