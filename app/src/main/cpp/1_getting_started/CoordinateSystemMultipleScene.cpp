...
#include "CoordinateSystemMultipleScene.h"
...
void CoordinateSystemMultipleScene::init() {
...
void CoordinateSystemMultipleScene::resize(int width, int height) {
    glViewport(0, 0, width, height);
    SCR_WIDTH = width;
    SCR_HEIGHT = height;
}

void CoordinateSystemMultipleScene::draw() {
// render
    // ------
...
void CoordinateSystemMultipleScene::destroy() {
