...
#ifndef LEARNGLES_TRANSFORMATIONCONTROLLERSCENE_H
#define LEARNGLES_TRANSFORMATIONCONTROLLERSCENE_H
...
class TransformationControllerScene : public Scene, public SceneCommand {
public:
    void init() override;
...
#endif //LEARNGLES_TRANSFORMATIONCONTROLLERSCENE_H
