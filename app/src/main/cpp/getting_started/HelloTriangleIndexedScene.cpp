...
#include "HelloTriangleIndexedScene.h"
...
void HelloTriangleIndexedScene::init() {
...
void HelloTriangleIndexedScene::resize(int width, int height) {

}

void HelloTriangleIndexedScene::draw() {
    // render
    // ------
...
void HelloTriangleIndexedScene::destroy() {
