...
// -------------------------
    pbrShader = new Shader("6/2.1.2.pbr.vsh", "6/2.1.2.pbr.fsh");
    equirectangularToCubemapShader = new Shader("6/2.1.2.cubemap.vsh", "6/2.1.2.equirectangular_to_cubemap.fsh");
    irradianceShader = new Shader("6/2.1.2.cubemap.vsh", "6/2.1.2.irradiance_convolution.fsh");
    backgroundShader = new Shader("6/2.1.2.background.vsh", "6/2.1.2.background.fsh");
...
void IblIrradianceScene::renderSphere()
{
...
void IblIrradianceScene ::renderCube()
{
