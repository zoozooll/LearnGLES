...
void AsteroidScene::init() {
    ...
    // -------------------------
    m_pAsteroidShader = new Shader("shaders/asterioid/10.3.asteroids.vert", "shaders/asterioid/10.3.asteroids.frag");
    m_pPlanetShader = new Shader("shaders/asterioid/10.3.planet.vert", "shaders/asterioid/10.3.planet.frag");
...
std::map<std::string, std::any> AsteroidScene::propertyEvent(std::map<std::string, std::any> &map) {
...
void AsteroidScene::parseTargetCameraEvent(std::map<std::string, std::any> &event) {
