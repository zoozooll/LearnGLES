...
void MultiLightsScene::init() {
    ...
    // ------------------------------------
    m_pLightingShader = new Shader("shaders/multiple_lights/6.multiple_lights.vs", "shaders/multiple_lights/6.multiple_lights.fs");
    m_pLightCubeShader = new Shader("shaders/multiple_lights/6.light_cube.vs", "shaders/multiple_lights/6.light_cube.fs");
