...
void PbrTextureScene::resize(int width, int height) {
...
std::map<std::string, std::any> PbrTextureScene::propertyEvent(std::map<std::string, std::any> &map) {
...
void PbrTextureScene::parseTargetCameraEvent(std::map<std::string, std::any> &event) {
